...
public class LevelControllerTest {
    ...
    @Test
    public void should_return_basic_when_levelNumber_equals_1() throws Exception {
    ...
    @Test
    public void should_return_basic_when_levelNumber_is_greater_than_1() throws Exception {
